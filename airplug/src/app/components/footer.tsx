    ...
    return (
        <>
            <footer className="lg:min-h-[300px] w-full lg:mt-5 p-8 min-h-[550px] bg-gray-50 lg:bg-transparent md:px-20 pb-20 shadow-lg rounded-lg border border-top-2">
                <div className="lg:max-w-7xl lg:h-[350px] h-[500px] mx-auto">
                    <div className="lg:flex justify-between lg:p-10">
                        <div className="lg:flex lg:flex-col gap-4">
                            <ul className="flex space-x-4 lg:mt-4 lg:py-3 py-7">
                                <li><a href="#" className="text-gray-700 hover:text-[#f1952c]"><FaXTwitter size={30} /></a></li>
                                <li><a href="#" className="text-gray-700 hover:text-[#f1952c] w-14"><FaDiscord size={30} /></a></li>
                                <li><a href="#" className="text-gray-700 hover:text-[#f1952c]"><FaTelegram size={30} /></a></li>
                                <li><a href="#" className="text-gray-700 hover:text-[#f1952c]"><FaGithub  size={30}/></a></li>
                            </ul>
                        </div>
                        <div className='lg:flex lg:flex-col items-start font-raleway text-xs font-semibold lg:px-5 gap-3 md:w-3/5'>
                            <p className='font-raleway text-lg text-gray-800'>Get Updates</p>
                        ...
                        <div className='flex justify-start lg:justify-center font-raleway text-sm font-normal mt-5 lg:mt-0'>
                            <ul className='lg:flex lg:flex-col space-y-3'>
                                <li><a href="" className='hover:text-[#f1952c]'>About</a></li>
                                <li><a href="" className='hover:text-[#f1952c]'>How to Buy?</a></li>
                                <li><a href="" className='hover:text-[#f1952c]'>Contact</a></li>
                            </ul>
                        </div>
                    </div>
                    <div className='lg:p-10 mt-20 lg:mt-0 lg:flex-row lg:justify-between lg:items-center flex flex-col gap-2'>
                        ...
                        <div className='lg:flex-row lg:justify-between lg:gap-3 flex flex-col gap-2'>
                            <Link href='#'>
                                <p className='text-sm text-gray-600 hover:text-[#f1952c]'>Terms & Conditions</p>
                            </Link>
                            <Link href='#'>
                                <p className='text-sm text-gray-600 hover:text-[#f1952c]'>Privacy Policy</p>
                            </Link>
                            <Link href='#'>
                                <p className='text-sm text-gray-600 hover:text-[#f1952c]'>FAQs</p>
                            </Link>
                        </div>
                    </div>
                </div>
